...
export const taskPageVoices = {
  article: {
    ...
    description: 'Use this page for essays, guides, explainers, and story-led posts. The layout feels like a publication, not a generic feed.',
  ...
  pdf: {
    ...
    description: 'PDF pages should feel like downloadable guides, reports, files, and reference material.',
